// Type definitions for redux-orm 0.12.1
...
declare module 'redux-orm' {
  ...
  export interface ModelFields {
    [index: string]: Attribute | ForeignKey | ManyToMany | OneToOne | any
  }
  ...
  export class Model<Fields, Additional = {}, VirtualFields = {}> {
    ...
    static withId(id: IdType): ModelWithFields<any, any, any>
    static hasId(id: IdType): boolean
    static _findDatabaseRows(lookupObj: object): any // TODO
    static get(lookupObj: object): ModelWithFields<any, any, any>
    static reducer(action: any, model: any, session: SessionWithModels<ORMCommonState>): void
